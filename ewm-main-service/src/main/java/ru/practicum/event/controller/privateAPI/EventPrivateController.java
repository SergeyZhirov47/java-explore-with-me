...
public class EventPrivateController {
    ...
    public EventFullDto addEvent(@PathVariable long userId, @Valid @RequestBody EventCreateDto eventCreateDto) {
        log.info("POST /users/{userId}/events, {userId} = {}, body = {}", userId, eventCreateDto);
    ...
    public EventFullDto editEvent(@PathVariable long userId,
        ...
        log.info("PATCH /users/{userId}/events/{eventId}, {userId} = {}, {eventId} = {}, body = {}", userId, eventId, eventUpdateDto);
    ...
    public EventRequestStatusUpdateResultDto changeRequestStatus(@PathVariable long userId,
        ...
        log.info("PATCH /users/{userId}/events/{eventId}/requests, {userId} = {}, {eventId} = {}, body = {}", userId, eventId, updateDataDto);
